    ...
    questions: {
        ...
        observation: [
            ...
            },
            {
                ...
                reference:
                    /* ── 原有參考答案 (OT366) ── */
                    '<b>奧祕的來源：</b>但以理明確指出奧祕來自「天上的上帝」(a God in heaven who reveals mysteries, v.28)。<br><br>' +
                    '<b>為何先否定再肯定？</b>根據 OT366，這是 <b>「拖延的藝術」(The Art of Delay)</b>。但以理必須先否定巴比倫最頂尖的專家（術士、巫師、觀兆的），才能凸顯出唯有以色列的神擁有真正的智慧。<br><br>' +
                    '他還特別加上一句：「這奧祕顯明給我，<b>並非因我智慧勝過一切活著的人</b>」(v.30)——這不是關於但以理比別人聰明，而是關於<b>「神的智慧」勝過「人的智慧」</b>。<br><br>' +
                    '<b>小結：</b>OT366 指出，本章的重點不是巨像之夢本身，而是<b>「真正的智慧在哪裏」</b>。但以理用了整整四節經文（v.27-30）來確立這一點，才開始說出夢的內容。' +

                    /* ── 新增參考答案 (Buster & Walton 2025) ── */
                    '<hr style="border:none;border-top:2px dashed #b2dfdb;margin:20px 0 16px;">' +
                    '<div style="background:#f0faf8;border-left:4px solid #00897b;padding:14px 16px;border-radius:0 8px 8px 0;">' +
                        '<p style="margin:0 0 4px;font-size:12px;color:#00897b;font-weight:700;">📚 延伸閱讀 — Buster &amp; Walton, <em>The Book of Daniel, Chapters 1–6</em> (NICOT, 2025)</p>' +
                    '</div>' +

                    '<h4 style="color:#00897b;margin:14px 0 6px;">奧祕的來源：絕對的神聖啟示</h4>' +
                    '<p>在第 27-30 節中，但以理明確指出這個奧祕的來源並非人類的智慧、占卜技巧或任何世俗的學問，而是完全來自「天上的神」（God in heaven）。他甚至在第 30 節特別澄清，這奧祕之所以向他顯明，「並非因我的智慧勝過一切活人」，而是神主動的啟示（divine revelation）。這表明解夢的能力是一種<b>神聖的恩賜</b>（divine gift），而非人類智力或修練的成果（p.&nbsp;332）。</p>' +

                    '<h4 style="color:#00897b;margin:14px 0 6px;">為何先強調哲士的無能？</h4>' +
                    '<p>Buster 和 Walton 指出，但以理先強調「智慧人、法術師都不能告訴王」，並不是為了嘲諷或貶低巴比倫的占卜術是騙局。相反地，但以理的聲明其實<b>完全符合並肯定了</b>古代近東占卜界的核心信念——人類本來就無法單憑己力掌握神明的奧祕（pp.&nbsp;327,&nbsp;399-400）。但以理藉由宣告人類的無能，確立了一個事實：國王所要求的事，超越了任何人類智慧與技能的極限，這是一項「<b>只有神明才能完成的任務</b>」。</p>' +

                    '<h4 style="color:#00897b;margin:14px 0 6px;">襯托「天上神」的恩典與獨特性</h4>' +
                    '<p>透過先承認全人類（包括他自己）的無能，但以理完美地襯托出「天上的神」的至高主權與恩典。這帶出了一個極具震撼力的神學對比：巴比倫的眾神明並沒有選擇將這奧祕向他們本國的哲士顯明；然而，但以理的神（天上的神）卻出於憐憫，主動向這位被擄的猶大青年啟示了這一切。</p>' +
                    '<p>因此，這段話的重點不在於但以理的個人能力超越了巴比倫哲士，而在於彰顯<b>但以理與他的神之間擁有一份獨特的關係</b>。神將奧祕啟示給他，是神對被擄子民<b>施恩（divine favor）的最高記號</b>（p.&nbsp;400）。</p>'
            },
            {
                id: 'obs3',
        ...
        application: [
            {
                id: 'app1',
                text: '尼布甲尼撒提出了一個無理且致命的要求（說出夢的內容！），這就像職場上老闆提出的「不可能任務」。當你面對超越你能力的挑戰時，你的第一反應是像迦勒底人一樣恐慌抱怨，還是像但以理一樣尋求屬靈夥伴（朋友）一起禱告？',
            ...
            {
                id: 'app2',
                text: '我們生活在一個政權更迭、國際局勢動盪的時代。但以理書告訴我們，即使是「金頭」般的強權也會過去，唯有神的國度長存。這種「永恆的眼光」的觀點如何幫助你減少對政治、經濟或社會局勢的焦慮？',
            ...
            {
                id: 'app3',
                text: '但以理成功解夢後，沒有邀功，而是將榮耀歸給神，說「並非因我智慧勝過一切活著的人」(v.30)，並且在升遷後提拔朋友 (v.49)。當你在工作或事奉中取得成就時，你如何向人表達這是恩典，而不是單單高舉自己？',
