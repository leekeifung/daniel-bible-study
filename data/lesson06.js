...
'</ul>' +
'</div>' +
'<h4 style="color:#00897b;margin:16px 0 8px;">2. 小角的身份：安提阿哥四世 (Antiochus IV Epiphanes)</h4>' +
...
'<li><strong>歷史應驗：</strong>學術界幾乎一致公認這指向塞琉古王朝的<strong>安提阿哥四世</strong>（主前 175-163 年）。他在主前 167 年褻瀆耶路撒冷聖殿，引發了馬加比革命，最終於主前 164 年聖殿得以潔淨（修殿節 Hanukkah 的由來）。</li>' +
'</ul>' +
...
'<ul>' +
'<li><strong>羅馬觀點：</strong>認為第 7 章第四獸是羅馬，故第 7 章小角出自羅馬（可能是敵基督）；第 8 章小角出自希臘（安提阿哥）。兩者是<strong>不同人</strong>。</li>' +
'<li><strong>希臘觀點 (OT366 傾向)：</strong>認為第 7 章第四獸是希臘，故兩章的小角<strong>都指向安提阿哥四世</strong>。</li>' +
'</ul>' +
'</div>' +
...
'<li><strong>安提阿哥四世</strong>（第 7-8 章小角）→ 禁止獻祭、毀壞聖所</li>' +
    ...
    questions: {
        ...
        observation: [
            ...
            },
            {
                ...
                reference: '<b>【焦點問題】</b>v.13：「這經常獻的祭、帶來荒涼的罪過、聖所與軍隊被踐踏的異象，<b>要持續到幾時呢？</b>」——聖者關心的核心問題是：苦難有多長？什麼時候結束？<br><br><b>【答案】</b>v.14：「要到二千三百日（原文：evening-morning），聖所就必潔淨。」OT366 (Segment 59) 指出許多學者將此理解為 1150 天（每天早晚各一次獻祭，2300÷2），約三年半。<br><br><b>【神學意義】</b>OT366 提到，「how long」的語言讓人想起哀歌詩篇，它是「something of a call for mercy」（求憐憫的呼喊）。在苦難中，信徒最關心的不是「為什麼」而是「到幾時」——受苦有沒有盡頭？答案是：<b>有</b>。神設定了期限，邪惡不能無限期肆虐。'
            }
        ],
        ...
        interpretation: [
            ...
            },
            {
                ...
                reference: '<b>(a)【「非因人手」的安慰】</b><br>這意味著：(1) 無論敵人多強大（甚至自比神），他的滅亡不由人類的軍事力量決定，而是神親自干預——保證了審判的<b>必然性</b>；(2) 受苦的百姓不需要靠自己的力量去推翻暴君——神會在祂的時間表中親自處理。<br><br>歷史應驗：安提阿哥四世確實不是在戰場上被人殺死，而是在主前 163 年因疾病（據記載是精神錯亂加上內臟疾病）去世。<br><br><b>(b)【第 8 章 vs 第 7 章的盼望】</b><br>OT366 (Segment 60) 精確指出：「Unlike chapter 7, which consoled the people with the hope of a future reign with the \'one like a son of man,\' chapter 8 <b>only offers the hope that evil won\'t last forever</b>. God will bring it to an end.」<br><br>第 7 章：邪惡結束 + 聖民與人子一同得國（正面展望）<br>第 8 章：邪惡結束……然後呢？沒有說。<br><br>這使得第 7 章作為書卷「樞紐」的角色更加重要——它是整卷書唯一提供全面正面盼望的章節。'
            }
        ],
        ...
        application: [
            ...
            },
            {
                ...
                reference: '<b>引導方向：</b><br>OT366 (Segment 59) 指出，聖者的問題「How long?」與哀歌詩篇的呼喊相同，是「a call for mercy」。而答案的重點不在於精確計算日期，而在於：<b>受苦有終點</b>。<br><br><b>具體應用：</b><br>在禱告中，你可以這樣宣告：<br>• 「主啊，我的受苦不是無限期的。你已經設定了終點。」<br>• 「即使我現在不知道還要多久，但我知道你知道。」<br>• 「你必潔淨與恢復——不只是聖殿，也是我的生命。」<br><br>這不是否認痛苦，而是在痛苦中錨定於盼望。'
            },
            {
                id: 'app3',
    ...
    quiz: [
        ...
        },
        {
            ...
            opts: [
                '尼布甲尼撒',
                '古列大帝',
                '塞琉古王朝的安提阿哥四世 (Antiochus IV Epiphanes)',
                '羅馬皇帝尼祿'
            ],
            ans: 2
        },
        ...
        // ── 配對題 (Match) ── 3 題
        {
            ...
            pairs: [
                ...
                { left: '從一角長出的小角', right: '面貌兇惡的王（安提阿哥四世）' }
            ]
        },
        {
            type: 'match',
            q: '請將第 7 章與第 8 章小角的「相似處」與「不同處」分類：',
            pairs: [
                { left: '都從小開始，漸漸壯大', right: '相似處' },
                { left: '都說誇大的話 / 自高自大', right: '相似處' },
                { left: '都逼迫神的聖民', right: '相似處' },
                { left: '第 7 章有十角再加一角；第 8 章有四角再加一角', right: '不同處' },
                { left: '第 7 章焦點在聖民；第 8 章焦點在聖所', right: '不同處' },
                { left: '第 7 章小角拔出三角；第 8 章沒有此描述', right: '不同處' }
            ]
        },
        {
            type: 'match',
            ...
            pairs: [
                ...
                { left: '第二層升級（第 7-8 章小角）', right: '安提阿哥四世——禁止獻祭、毀壞聖所' },
