...
'</div>'
    ...
    quiz: [
        ...
        {
    type: 'categorize', // 若您的系統支援分類拖曳，這是最適合的 type
    q: '請將以下關於第 7 章與第 8 章小角的描述，分類為「相似處」或「不同處」：',
    categories: ['相似處', '不同處'],
    items: [
        { text: '都從小開始，漸漸壯大', answer: '相似處' },
        { text: '都說誇大的話 / 自高自大', answer: '相似處' },
        { text: '都逼迫神的聖民', answer: '相似處' },
        { text: '第 7 章有十角再加一角；第 8 章有四角再加一角', answer: '不同處' },
        { text: '第 7 章焦點在聖民；第 8 章焦點在聖所', answer: '不同處' },
        { text: '第 7 章小角拔出三角；第 8 章沒有此描述', answer: '不同處' }
    ]
        },
        {
            type: 'match',
