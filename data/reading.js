...
window.LESSONS_DATA.push({
    ...
    articles: [
        ...
        },
        {
            ...
            categoryLabel: '神學主題 Theological Theme',
            html:
                '<p>加百列的解釋聚焦於異象中最重要的核心——讀者也應如此。本章已在註釋中先行處理。不像第七章被 Goldingay 比作「可開放多重詮釋的印象派畫作」，第八章的異象更像「在畫面上直接寫了名字的政治漫畫」，用來確保讀者明白。也正如政治漫畫，異象喚起許多畫面之外的意象與聯想。以下的解讀以歷史記錄對應加百列的說明而展開。</p>' +
                ...
                '<p>若「二千三百個『早晚』」（但 8:14 下）指具體時程，常見兩種理解：其一，二千三百日約等於六年，自大祭司俄尼亞三世於主前 170 年遇害起，至主前 164 年馬加比起義後聖殿重新奉獻止；其二，若計二千三百為日夜各算一次，則約一千一百五十天，迫害起點可定於主前 167 年安提阿古在埃及受挫之後。歷史層面看，「非因人手」的滅亡（8:25；參 NIV「不是因人力」）指安提阿古死於意外或疾病，而非戰死；神學層面則強調：他的日子在神手中，神一命定，壓迫者必被粉碎。<sup class="fn-mark" data-fn="1">1</sup></p>',
            footnotes: [
                {
                    num: 1,
                    bookKey: 'widder2023',
        ...
        },
        {
            ...
            categoryLabel: '神學主題 Theological Theme',
            html:
                '<p>但以理書與整本聖經故事的連結，體現在對類似人物的呼應、敘事空檔的補足，以及君王範式的塑造。</p>' +
                ...
                '<p><strong>其三，塑造王權的範式：</strong>耶和華是萬王之王，卻將大權託付給人間君王，期望他們公正照管子民，也要求他們承認權柄的來源。在但以理書 2–4 章，神如此教導尼布甲尼撒，他最終承認：「現在我－尼布甲尼撒讚美、尊崇、恭敬天上的王，因為他所行的全都信實，他所做的盡都公平。那行事驕傲的，他能降為卑。」（但以理書 4:37，和合本修訂版）尼布甲尼撒成為「外邦君王應當成為的範式」。相反地，伯沙撒飲用聖器、褻瀆以色列的神，成為敵對與褻慢神的外邦王典型。在但以理書中，伯沙撒最壞的後繼者是安提阿古四世以比法尼斯；在聖經宏大敘事裡，最終的對應者則是敵基督（如帖撒羅尼迦後書 2:3）。<sup class="fn-mark" data-fn="1">1</sup></p>',
            footnotes: [
                {
                    num: 1,
                    bookKey: 'widder2026',
