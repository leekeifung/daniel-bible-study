...
// 但以理書 9:1-27 (RCUV)
// 對應 OT366 Unit 10 (Segments 62-76) | 基於 Dr. Widder 講座內容編製
// 神學立場：尊重歷史與末世觀點的多元性，聚焦核心真理（禱告、主權、悔改、聖約）
// ==========================================
...
'<p>OT366 指出：但以理不只是在「等」七十年期滿，他研讀了耶利米的信（耶 29:10-11），發現恢復的條件不只是時間到了，還需要<strong>認罪與尋求神</strong>。因此，但以理作為百姓的代表，做了耶利米所說的事——禱告、認罪、尋求神。</p>'+
'<div class="highlight-box">' +
'<p><strong>📘 耶利米書簡介與核心信息 </strong></p>' +
'<ul>' +
'<li><strong>書名意義：</strong>「耶利米」意為「神必拋出」或「神必建立」。</li>' +
'<li><strong>作者與背景：</strong>先知耶利米，素有「流淚的先知」之稱，寫作日期約主前 600 年。</li>' +
'<li><strong>被擄七十年（耶 25:11-12）：</strong>「這全地必然荒涼，令人驚駭。這些國家要服事巴比倫王七十年。七十年滿了以後，我必懲罰巴比倫王和那國，並迦勒底人之地，因他們的罪孽使那地永遠荒涼。這是耶和華說的。」</li>' +
'<li><strong>歸回與盼望（耶 29:10-11）：</strong>「耶和華如此說：為巴比倫所定的七十年滿了以後，我要眷顧你們，向你們實現我的恩言，使你們歸回此地。「我知道我向你們所懷的意念是賜平安的意念，不是降災禍的意念，要叫你們末後有指望。這是耶和華說的。」</li>' +
'</ul>' +
'</div>'
        },
        {
...
'</div>'
    ...
    quiz: [
        ...
        {
            type: 'mc',
            q: '將「七十個七」的六重目的分為「消除罪」與「成就義」兩組，下列何者分類完全正確？',
            opts: [
                '<b style="color:#c62828;">消除罪</b>：止住罪過、除淨罪惡、贖盡罪孽 ｜ <b style="color:#1a237e;">成就義</b>：引進永恆的公義、封住異象和預言、膏至聖所',
                '<b style="color:#c62828;">消除罪</b>：止住罪過、引進永恆的公義、封住異象和預言 ｜ <b style="color:#1a237e;">成就義</b>：除淨罪惡、贖盡罪孽、膏至聖所',
                '<b style="color:#c62828;">消除罪</b>：止住罪過、除淨罪惡、引進永恆的公義 ｜ <b style="color:#1a237e;">成就義</b>：贖盡罪孽、封住異象和預言、膏至聖所',
                '<b style="color:#c62828;">消除罪</b>：止住罪過、除淨罪惡、膏至聖所 ｜ <b style="color:#1a237e;">成就義</b>：引進永恆的公義、封住異象和預言、贖盡罪孽'
            ],
            ans: 0
        },
        {
